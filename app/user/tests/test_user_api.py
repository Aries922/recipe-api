...
class PublicUserApiTest(TestCase):
    ...
    def test_for_create_valid_user(self):
    ...
    def test_password_too_short(self):
        payload = {'email': 'amit@gmail.com', 'password': 'pw'}
    ...
    def test_create_token_for_user(self):
        payload = {'email': 'amit@gmail.com', 'password': 'aries'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        create_user(email='amit@gmail.com', password='aries')
        payload = {'email': 'amit@gmail.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
